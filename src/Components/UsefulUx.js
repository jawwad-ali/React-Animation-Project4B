...
import useWebAnimations , {fadeInLeftBig , fadeInDown} from "@wellyshen/use-web-animations";
import "./UsefulUx.css"
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-4 bs-cards" ref={ref}>
                        <div class="card">
                            <img className="sampleImgSection" class="card-img-top" src={chatbot} alt="Card image cap" />
                            <div class="card-body">
                                <h5 class="card-title">Scripted Chatbot</h5>
                                <p class="card-text">Conversation design guidelines such as chatbot personality, flowcharts, and
                                ...
                                <a href="#" class="text-primary">Case Study</a>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 bs-cards" ref={b}>
                        <div class="card">
                            <img className="sampleImgSection" class="card-img-top" src={startScale} alt="Card image cap" />
                            <div class="card-body">
                                <h5 class="card-title">Product Development</h5>
                                <p class="card-text">As the sole UX writer on a product team building the 'Uber of marketing', I 
                    ...
                    <div className="col-lg-4 bs-cards" ref={c}>
                        <div class="card">
                            <img className="sampleImgSection" class="card-img-top" src={speed} alt="Card image cap" />
                            <div class="card-body">
                                <h5 class="card-title">User Onboarding</h5>
                                <p class="card-text">Here is the first screen in an onboarding process I wrote for a SaaS product.
